...
export default {
    createPage: async (title, page_content, activated) => {
        return await axios.post('/dashboardAPI/pages', { title: title, page_content: page_content, activated: activated })
    },
    editPage: async (id, title, page_content, activated) => {
        return await axios.put('/dashboardAPI/pages/' + id, { title: title, page_content: page_content, activated: activated })
